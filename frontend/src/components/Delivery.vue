<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <String label="CustomerAdress" v-model="value.customerAdress" :editMode="editMode"/>
            <String label="ProductNumber" v-model="value.productNumber" :editMode="editMode"/>
            <Number label="Qty" v-model="value.qty" :editMode="editMode"/>
            <Date label="Orderid" v-model="value.orderid" :editMode="editMode"/>
