<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="CustomerAdress" v-model="item.customerAdress" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="ProductNumber" v-model="item.productNumber" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="Qty" v-model="item.qty" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Date label="Orderid" v-model="item.orderid" :editMode="editMode" @change="change" />
            </div>
            <div>
