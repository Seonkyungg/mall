...
import mall.domain.StockDecrised;
...
public class Inventory  {
    ...
    public void onPostPersist(){
        ...
        StockDecrised stockDecrised = new StockDecrised(this);
        stockDecrised.publishAfterCommit();
    ...
    public static void decriseStock(DeliveryCompleted deliveryCompleted){
    ...
    public static void incriseStock(DeliveryReturned deliveryReturned){
